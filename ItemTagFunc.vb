...
<System.Runtime.InteropServices.ProgId("ItemTag.ItemTagFunc")> Public Class ItemTagFunc
    ...
    '*************************************************************************
    ' GPK start
    Const CONST_TrainNumberAttributeName As String = "TrainNumber" 'I18_OK
    Const CONST_ProcessSubUnitAttributeName As String = "ProcessSubUnit" 'I18_OK

    Const CONST_EquipmentTypeIdentificationAttributeName As String = "EquipmentTypeIdentification" 'I18_OK
    Const CONST_EquipmentSeriesNumberAttributeName As String = "EquipmentSeriesNumber" 'I18_OK
    Const CONST_SuffixLetterAttributeName As String = "SuffixLetter" 'I18_OK

    Const CONST_OperFluidCodeAttributeName As String = "OperFluidCode" 'I18_OK
    Const CONST_LineNumberAttributeName As String = "LineNumber" 'I18_OK
    Const CONST_NominalDiameterAttributeName As String = "NominalDiameter" 'I18_OK
    Const CONST_PipingMaterialsClassAttributeName As String = "PipingMaterialsClass" 'I18_OK
    Const CONST_InsulationCode1AttributeName As String = "InsulationCode_1" 'I18_OK
    Const CONST_InsulationCode2AttributeName As String = "InsulationCode_2" 'I18_OK
    Const CONST_InsulationCode3AttributeName As String = "InsulationCode_3" 'I18_OK

    Const CONST_FunctionalIdentification1AttributeName As String = "FunctionalIdentification_1" 'I18_OK
    Const CONST_FunctionalIdentification2AttributeName As String = "FunctionalIdentification_2" 'I18_OK
    Const CONST_FunctionalIdentification3AttributeName As String = "FunctionalIdentification_3" 'I18_OK
    Const CONST_FunctionalIdentification4AttributeName As String = "FunctionalIdentification_4" 'I18_OK

    Const CONST_InstrumentSeriesNumberAttributeName As String = "InstrumentSeriesNumber" 'I18_OK
    Const CONST_ElementTypeAttributeNumber As String = "ElementType" 'I18_OK
    ...
    Private Function GetShortValue(Item As Llama.LMAItem, att_name As String) As String
        Dim Att_Index As Long
        Dim I As Integer

        Att_Index = Item.Attributes(att_name).ISPAttribute.Index

        With Item.Attributes(att_name).ISPAttribute.Attribution.ISPEnumAtts
            For I = 1 To .Count
                If Att_Index = .Item(I).Index Then
                    GetShortValue = .Item(I).Description
                    Exit Function
                End If
            Next
        End With
...
ErrorHandler:
        ...
        LogError("ItemTag - ItemTagFunc::GetShortValue --> " & Err.Description)
        ...
        For Each objLMAItem In Items
            ...
            Select Case objLMAItem.Attributes(CONST_PlantItemTypeAttributeName).Index
                ...
                Case CONST_PipingCompItemIndex
                    ...
                    UpdateItemTag = UpdatePipingCompTag(Datasource, Datasource.GetPipingComp((objLMAItem.Id)), varValue, strPropertyName)
                    BNotAnyCase = False
                Case Else
                    UpdateItemTag = True
            End Select
...
ErrorHandler:
    ...
    Private Function UpdatePipingCompTag(ByRef Datasource As Llama.LMADataSource, ByRef Item As Llama.LMPipingComp, ByRef varValue As Object, ByRef strPropertyName As String) As Boolean
        ...
        ' MsgBox(Item.Attributes(CONST_ProcessSubUnitAttributeName).ISPAttribute.AttName) ' ProcessSubUnit
        ' MsgBox(Item.Attributes(CONST_ProcessSubUnitAttributeName).ISPAttribute.Index.ToString()) ' 4
        ' MsgBox(Item.Attributes(CONST_ProcessSubUnitAttributeName).ISPAttribute.Value.ToString) ' Feed cooling

        'With Item.Attributes(CONST_ProcessSubUnitAttributeName).ISPAttribute.Attribution.ISPEnumAtts
        'For i = 1 To .Count
        'If Item.Attributes(CONST_ProcessSubUnitAttributeName).ISPAttribute.Index = .Item(i).Index Then
        ...
        With colTagValues
            ...
            Select Case strPropertyName
                Case CONST_TrainNumberAttributeName
                    .Add(Trim(VariantToString(varValue)), strPropertyName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ElementTypeAttributeNumber)), CONST_ElementTypeAttributeNumber)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_InstrumentSeriesNumberAttributeName).Value))), CONST_InstrumentSeriesNumberAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_SuffixLetterAttributeName).Value))), CONST_SuffixLetterAttributeName)

                Case CONST_ProcessSubUnitAttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    Item.Attributes.Item(strPropertyName).Value = varValue
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ElementTypeAttributeNumber)), CONST_ElementTypeAttributeNumber)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_InstrumentSeriesNumberAttributeName).Value))), CONST_InstrumentSeriesNumberAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_SuffixLetterAttributeName).Value))), CONST_SuffixLetterAttributeName)

                Case CONST_ElementTypeAttributeNumber
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    Item.Attributes.Item(strPropertyName).Value = varValue
                    .Add(Trim(GetShortValue(Item, CONST_ElementTypeAttributeNumber)), CONST_ElementTypeAttributeNumber)
                ...
                Case CONST_InstrumentSeriesNumberAttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    Item.Attributes.Item(strPropertyName).Value = varValue
                    .Add(Trim(GetShortValue(Item, CONST_ElementTypeAttributeNumber)), CONST_ElementTypeAttributeNumber)
                ...
                Case CONST_SuffixLetterAttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    Item.Attributes.Item(strPropertyName).Value = varValue
                    .Add(Trim(GetShortValue(Item, CONST_ElementTypeAttributeNumber)), CONST_ElementTypeAttributeNumber)
        ...
        strItemTag = UCase(colTagValues.Item(CONST_TrainNumberAttributeName) & colTagValues.Item(CONST_ProcessSubUnitAttributeName) & colTagValues.Item(CONST_ElementTypeAttributeNumber) & colTagValues.Item(CONST_InstrumentSeriesNumberAttributeName) & colTagValues.Item(CONST_SuffixLetterAttributeName))

        'If (colTagValues.Item(CONST_TrainNumberAttributeName) <> "" And colTagValues.Item(CONST_ProcessSubUnitAttributeName) <> "" And colTagValues.Item(CONST_ElementTypeAttributeNumber) <> "" And colTagValues.Item(CONST_InstrumentSeriesNumberAttributeName) <> "") Then
        'bUniqueStatus = CheckForPipingCompUnique(Datasource, Item, strItemTag, strDupMessage)
        'bUniqueStatus = True
        'If bUniqueStatus = False Then
        'MsgBox(strDupMessage)
        'Else
        ...
        UpdatePipingCompTag = True

        Exit Function

ErrorHandler:
        LogError("ItemTag - ItemTagFunc::UpdatePipingCompTag --> " & Err.Description)
        Err.Clear()
    ...
    Private Function UpdateInstrTag(ByRef Datasource As Llama.LMADataSource, ByRef Item As Llama.LMInstrument, ByRef varValue As Object, ByRef strPropertyName As String) As Boolean
        ...
        With colTagValues
            ...
            Select Case strPropertyName
                ...
                Case CONST_TrainNumberAttributeName
                    .Add(Trim(VariantToString(varValue)), strPropertyName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_FunctionalIdentification1AttributeName)), CONST_FunctionalIdentification1AttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_FunctionalIdentification2AttributeName)), CONST_FunctionalIdentification2AttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_FunctionalIdentification3AttributeName)), CONST_FunctionalIdentification3AttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_FunctionalIdentification4AttributeName)), CONST_FunctionalIdentification4AttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_InstrumentSeriesNumberAttributeName).Value))), CONST_InstrumentSeriesNumberAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_SuffixLetterAttributeName).Value))), CONST_SuffixLetterAttributeName)
                ...
                Case CONST_FunctionalIdentification1AttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    Item.Attributes.Item(strPropertyName).Value = varValue
                    .Add(Trim(GetShortValue(Item, CONST_FunctionalIdentification1AttributeName)), CONST_FunctionalIdentification1AttributeName)
                ...
                Case CONST_FunctionalIdentification2AttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_FunctionalIdentification1AttributeName)), CONST_FunctionalIdentification1AttributeName)
                    Item.Attributes.Item(strPropertyName).Value = varValue
                ...
                Case CONST_FunctionalIdentification3AttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_FunctionalIdentification1AttributeName)), CONST_FunctionalIdentification1AttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_FunctionalIdentification2AttributeName)), CONST_FunctionalIdentification2AttributeName)
                ...
                Case CONST_FunctionalIdentification4AttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_FunctionalIdentification1AttributeName)), CONST_FunctionalIdentification1AttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_FunctionalIdentification2AttributeName)), CONST_FunctionalIdentification2AttributeName)
        ...
        strItemTag = UCase(colTagValues.Item(CONST_TrainNumberAttributeName) & colTagValues.Item(CONST_ProcessSubUnitAttributeName) & colTagValues.Item(CONST_FunctionalIdentification1AttributeName) & colTagValues.Item(CONST_FunctionalIdentification2AttributeName) & colTagValues.Item(CONST_FunctionalIdentification3AttributeName) & colTagValues.Item(CONST_FunctionalIdentification4AttributeName) & colTagValues.Item(CONST_InstrumentSeriesNumberAttributeName) & colTagValues.Item(CONST_SuffixLetterAttributeName))

        'If (colTagValues.Item(CONST_TrainNumberAttributeName) <> "" And colTagValues.Item(CONST_ProcessSubUnitAttributeName) <> "" And colTagValues.Item(CONST_FunctionalIdentification1AttributeName) <> "" And colTagValues.Item(CONST_EquipmentSeriesNumberAttributeName) <> "") Then
...
ErrorHandler:
        LogError("ItemTag - ItemTagFunc::UpdateInstrTag --> " & Err.Description)
        Err.Clear()
        colTagValues = Nothing
...
ErrorHandler:
    ...
    Private Function UpdatePipeRunTag(ByRef Datasource As Llama.LMADataSource, ByRef Item As Llama.LMPipeRun, ByRef varValue As Object, ByRef strPropertyName As String) As Boolean
        ...
        With colTagValues
            ...
            Select Case strPropertyName
                ...
                Case CONST_TrainNumberAttributeName
                    .Add(Trim(VariantToString(varValue)), strPropertyName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_OperFluidCodeAttributeName).Value))), CONST_OperFluidCodeAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_LineNumberAttributeName).Value))), CONST_LineNumberAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_NominalDiameterAttributeName).Value))), CONST_NominalDiameterAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_PipingMaterialsClassAttributeName).Value))), CONST_PipingMaterialsClassAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_InsulationCode1AttributeName)), CONST_InsulationCode1AttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_InsulationCode2AttributeName)), CONST_InsulationCode2AttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_InsulationCode3AttributeName)), CONST_InsulationCode3AttributeName)
                ...
                Case CONST_LineNumberAttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_OperFluidCodeAttributeName).Value))), CONST_OperFluidCodeAttributeName)
                    .Add(Trim(VariantToString(varValue)), strPropertyName)
                ...
                Case CONST_NominalDiameterAttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_OperFluidCodeAttributeName).Value))), CONST_OperFluidCodeAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_LineNumberAttributeName).Value))), CONST_LineNumberAttributeName)
                ...
                Case CONST_PipingMaterialsClassAttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_OperFluidCodeAttributeName).Value))), CONST_OperFluidCodeAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_LineNumberAttributeName).Value))), CONST_LineNumberAttributeName)
                ...
                Case CONST_InsulationCode1AttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_OperFluidCodeAttributeName).Value))), CONST_OperFluidCodeAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_LineNumberAttributeName).Value))), CONST_LineNumberAttributeName)
                ...
                Case CONST_InsulationCode2AttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_OperFluidCodeAttributeName).Value))), CONST_OperFluidCodeAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_LineNumberAttributeName).Value))), CONST_LineNumberAttributeName)
                ...
                Case CONST_InsulationCode3AttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_OperFluidCodeAttributeName).Value))), CONST_OperFluidCodeAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_LineNumberAttributeName).Value))), CONST_LineNumberAttributeName)
        ...
        strItemTag = UCase(colTagValues.Item(CONST_TrainNumberAttributeName) & colTagValues.Item(CONST_ProcessSubUnitAttributeName) & colTagValues.Item(CONST_OperFluidCodeAttributeName) & "-" & colTagValues.Item(CONST_LineNumberAttributeName) & "-" & colTagValues.Item(CONST_NominalDiameterAttributeName) & "-" & colTagValues.Item(CONST_PipingMaterialsClassAttributeName) & "-" & colTagValues.Item(CONST_InsulationCode1AttributeName) & colTagValues.Item(CONST_InsulationCode2AttributeName) & colTagValues.Item(CONST_InsulationCode3AttributeName))

        'If (colTagValues.Item(CONST_TrainNumberAttributeName) <> "" And colTagValues.Item(CONST_ProcessSubUnitAttributeName) <> "" And colTagValues.Item(CONST_OperFluidCodeAttributeName) <> "" And colTagValues.Item(CONST_LineNumberAttributeName) <> "" And colTagValues.Item(CONST_NominalDiameterAttributeName) <> "" And colTagValues.Item(CONST_PipingMaterialsClassAttributeName) <> "") Then
        ...
        'If bUniqueStatus = False Then
        'MsgBox("Dublicate tag `" & strItemTag & "` for PipeRun found in active plant")
        'Else
        Item.ItemTag = strItemTag
        Item.Commit()
        'End If
...
ErrorHandler:
    ...
    Private Function UpdateEquipTag(ByRef Datasource As Llama.LMADataSource, ByRef Item As Llama.LMEquipment, ByRef varValue As Object, ByRef strPropertyName As String) As Boolean
        ...
        With colTagValues
            ...
            Select Case strPropertyName
                ...
                Case CONST_TrainNumberAttributeName
                    .Add(Trim(VariantToString(varValue)), strPropertyName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_EquipmentTypeIdentificationAttributeName)), CONST_EquipmentTypeIdentificationAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_EquipmentSeriesNumberAttributeName).Value))), CONST_EquipmentSeriesNumberAttributeName)
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_SuffixLetterAttributeName).Value))), CONST_SuffixLetterAttributeName)
                ...
                Case CONST_EquipmentTypeIdentificationAttributeName
                    Item.Attributes.Item(strPropertyName).Value = varValue
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_EquipmentTypeIdentificationAttributeName)), CONST_EquipmentTypeIdentificationAttributeName)
                ...
                Case CONST_EquipmentSeriesNumberAttributeName
                    .Add(Trim(VariantToString((Item.Attributes.Item(CONST_TrainNumberAttributeName).Value))), CONST_TrainNumberAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_EquipmentTypeIdentificationAttributeName)), CONST_EquipmentTypeIdentificationAttributeName)
                    .Add(Trim(GetShortValue(Item, CONST_ProcessSubUnitAttributeName)), CONST_ProcessSubUnitAttributeName)
                    .Add(Trim(VariantToString(varValue)), strPropertyName)
        ...
        strItemTag = UCase(colTagValues.Item(CONST_TrainNumberAttributeName) & colTagValues.Item(CONST_ProcessSubUnitAttributeName) &
                           colTagValues.Item(CONST_EquipmentTypeIdentificationAttributeName) & colTagValues.Item(CONST_EquipmentSeriesNumberAttributeName) & colTagValues.Item(CONST_SuffixLetterAttributeName))


        'If (colTagValues.Item(CONST_TrainNumberAttributeName) <> "" And colTagValues.Item(CONST_ProcessSubUnitAttributeName) <> "" And colTagValues.Item(CONST_EquipmentTypeIdentificationAttributeName) <> "" And colTagValues.Item(CONST_EquipmentSeriesNumberAttributeName) <> "") Then
